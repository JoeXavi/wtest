locals {
  s3_origin_id  = "s3-${var.name_prefix}-web"
  alb_origin_id = "alb-${var.name_prefix}-api"

  csp_connect_src = join(" ", concat(
    ["'self'"],
    var.psp_connect_src_hosts
  ))
...
resource "aws_cloudfront_response_headers_policy" "security" {
  ...
  comment = "HSTS, CSP, and related security headers for Norte"
